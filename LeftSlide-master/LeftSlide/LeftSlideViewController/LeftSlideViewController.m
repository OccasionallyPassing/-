                     ...
                     andMainView:(UIViewController *)mainVC
{
    if(self = [super init]){
        ...
        self.leftTableview.backgroundColor = [UIColor orangeColor];
...
- (void) handlePan: (UIPanGestureRecognizer *)rec{
    ...
    NSLog(@"scalef = %f,self.mainVC.view.x = %f,point.x = %f,rec.view.x = %f",_scalef,self.mainVC.view.x,point.x,rec.view.x);
